...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/icy-cherry-2049
```

A live public deployment of this template is available at [https://icy-cherry-2049.templates.workers.dev](https://icy-cherry-2049.templates.workers.dev)
